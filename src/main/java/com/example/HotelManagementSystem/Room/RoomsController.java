...
public class RoomsController {
    ...
    public static void editRoom(LinkedList<Room> rooms, Scanner scanner){
        ...
        if (roomToEdit != null) {
            ...
            if(floor == -1){System.out.println("Room Floor:" + roomToEdit.getFloor() + "(same as before)");}
            else{
            ...
            if(capacity == -1){System.out.println("Room Capacity:" + roomToEdit.getCapacity() + "(same as before)");}
            else{
            ...
            if(type.equals("-1")){System.out.println("Room Type:" + roomToEdit.getType() + "(same as before)");}
            else{
            ...
            if (price == -1) {System.out.println("Room Price:" + roomToEdit.getPrice()+ "(same as before)");}
            else{
            ...
            if (price == -1) {System.out.println("Room Description:" + roomToEdit.getDescription()+ "(same as before)");}
            else{
